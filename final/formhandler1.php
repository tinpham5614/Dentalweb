...
mail ('tinpham5614@yahoo.com', $subject, $body, $from);

header('Location: thx1.html'); // replace "thx.html" with the name and path to your actual thank you page